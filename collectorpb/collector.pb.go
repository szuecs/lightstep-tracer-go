...
func (Reference_Relationship) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{4, 0} }
...
type SpanContext struct {
	...
	// Note: this is wire-compatible with map<string, string>, found in an earlier version
	// of this protocol; we avoid use of map<> directly because of the cost of `proto.Size`
	// over map fields, which performs several allocations.
	Baggage []*SpanContextEntry `protobuf:"bytes,3,rep,name=baggage" json:"baggage,omitempty"`
}
...
func (m *SpanContext) GetBaggage() []*SpanContextEntry {
	if m != nil {
		return m.Baggage
	}
	return nil
...
func (m *SpanContextEntry) Reset()                    { *m = SpanContextEntry{} }
func (m *SpanContextEntry) String() string            { return proto.CompactTextString(m) }
func (*SpanContextEntry) ProtoMessage()               {}
func (*SpanContextEntry) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *SpanContextEntry) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *SpanContextEntry) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func (*MetricsSample) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*InternalMetrics) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*Auth) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*ReportRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func (*Command) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func init() {
	...
	proto.RegisterType((*SpanContextEntry)(nil), "lightstep.collector.SpanContextEntry")
...
var fileDescriptor0 = []byte{
	...
	,
}
